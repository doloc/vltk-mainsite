        ...
        <>
            ...
            <div className="relative w-full h-screen overflow-hidden">
                ...
                <div className="absolute bottom-[8%] mb:bottom-[11%] flex w-full justify-center items-center text-[1.4vw] mb:text-[10px] text-[#FCFFC5] font-bold" style={{fontFamily: 'UTM Alberta Heavy'}}>
                    <Link href="/loi-dai" className='flex justify-center items-center w-[16%] mb:w-[28%] -mx-[0.7%] mb:-mx-[2.5%] bg-cover bg-center bg-no-repeat aspect-[328/101] bg-[image:var(--bg-nav-url)] hover:cursor-pointer hover:brightness-110' style={{'--bg-nav-url': `url(/images/event-loidai/btn-nav-bg.png)`} as CustomStyleProperties}>GIỚI THIỆU</Link>
                    <Link href="/loi-dai/the-le" className='flex justify-center items-center w-[16%] mb:w-[28%] -mx-[0.7%] mb:-mx-[2.5%] bg-cover bg-center bg-no-repeat aspect-[328/101] bg-[image:var(--bg-nav-url)] hover:cursor-pointer hover:brightness-110' style={{'--bg-nav-url': `url(/images/event-loidai/btn-nav-bg.png)`} as CustomStyleProperties}>THỂ LỆ</Link>
                    <Link href="/loi-dai/phan-thuong" className='flex justify-center items-center w-[16%] mb:w-[28%] -mx-[0.7%] mb:-mx-[2.5%] bg-cover bg-center bg-no-repeat aspect-[328/101] bg-[image:var(--bg-nav-url)] hover:cursor-pointer hover:brightness-110' style={{'--bg-nav-url': `url(/images/event-loidai/btn-nav-bg.png)`} as CustomStyleProperties}>PHẦN THƯỞNG</Link>
                    <Link href="/su-kien" className='flex justify-center items-center w-[16%] mb:w-[28%] -mx-[0.7%] mb:-mx-[2.5%] bg-cover bg-center bg-no-repeat aspect-[328/101] bg-[image:var(--bg-nav-url)] hover:cursor-pointer hover:brightness-110' style={{'--bg-nav-url': `url(/images/event-loidai/btn-nav-bg.png)`} as CustomStyleProperties}>TIN TỨC</Link>
                </div>
